...
class WatchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create watch" do
    assert_difference("Watch.count") do
      post watches_url, params: { watch: { content: @watch.content, description: @watch.description, price: @watch.price, title: @watch.title } }
    end
  ...
  test "should update watch" do
    patch watch_url(@watch), params: { watch: { content: @watch.content, description: @watch.description, price: @watch.price, title: @watch.title } }
